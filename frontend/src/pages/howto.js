...
export default function HowtoPage() {
  return (
    <Container>
      ...
      <Text>First, you must have a small amount of BNB for the operation to take place.<br/>Make sure you are connect to Binance Smart Chain network.</Text>
      <Text>Here is how to connect to Binance Smart Chain network:</Text>
      <div style={{paddingLeft: '16px'}}>
        <Text>Click on Add Network at the top-right corner and manually fill the below informations.</Text>
        <Text>
      ...
      <Text>There will be a video tutorial for this swap out soon. Stay tune via <a href='https://t.me/selendraorg'>t.me/selendraorg</a></Text>
    </Container>
  )
}
